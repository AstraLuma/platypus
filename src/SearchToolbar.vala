...
namespace Platypus.Widgets {

    public class SearchToolbar : Gtk.Toolbar {
        // Parent window
        private weak PlatypusWindow window;
        ...
        public SearchToolbar (PlatypusWindow window) {
            this.window = window;
        ...
        void search_changed_cb () {
            try {
                ...
                this.window.terminal.search_set_gregex (regex, 0);
                this.window.terminal.search_set_wrap_around (true);
            } catch (RegexError er) {
        ...
        public void previous_search () {
            this.window.terminal.search_find_previous ();
        }

        public void next_search () {
            this.window.terminal.search_find_next ();
        }
    }
}
